...
urlpatterns = [
    ...
    url(r'^woaixiaoyueyue/fireworks/$t', TemplateView.as_view(template_name="other/fireworks.html"), name="fireworks"),
    url(r'^woaixiaoyueyue/fireworks2/$t', TemplateView.as_view(template_name="other/fireworks2.html"), name="fireworks2"),
]
